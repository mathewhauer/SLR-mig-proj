...
for (i in 1:STEPS){
  ...
  S <- readMM(paste0("./R/DATA-PROCESSED/MATRICES/S",i,this.prob,"45.mtx"))
  MS <- readMM(paste0("./R/DATA-PROCESSED/MATRICES/MS",i,this.prob,"45.mtx"))
...
write_csv(proj, "./R/DATA-PROCESSED/PROJECTIONS/projections_AS_MSP45.csv")