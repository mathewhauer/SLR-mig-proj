...
together3eae <- together3 %>%
  filter(prob2 == "p50", ###### USING the 95th percentile of RCP 4.5. See https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/2014EF000239 TABLE 1 for the SLR amount in 2100
         SSP2 == "SSP2",
         year >=2020) %>%
  ungroup() %>%
...
write_csv(z, "./R/DATA-PROCESSED/atriskpops45.csv")
write_csv(together3, "./R/DATA-PROCESSED/basepercentagepoploss45.csv")
