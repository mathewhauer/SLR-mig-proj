...
reductions <- read_csv("./R/DATA-PROCESSED/atriskpops45.csv")
...
for (i in 1:STEPS){
  for(this.prob in c("p5", "p50", "p95")){
    ...
    writeMM(get(paste0("S",i, this.prob)), file = paste0("./R/DATA-PROCESSED/MATRICES/S",i,this.prob,"45.mtx" ))
  }
}
...
# }
   ...
   assign(paste0("S",i,this.prob), readMM(paste0("./R/DATA-PROCESSED/MATRICES/S",i,this.prob,"45.mtx")))
  ...
  # assign(paste0("MS",i, "p95"), migmatr %*% get(paste0("S",i,"p95")))
   ...
   # assign(paste0("MS",i, "p50"), migmatr %*% get(paste0("S",i,"p50")))
   # assign(paste0("MS",i, "p95"), migmatr %*% get(paste0("S",i,"p95")))
  writeMM(get(paste0("MS",i,this.prob)),  file = paste0("./R/DATA-PROCESSED/MATRICES/MS",i,this.prob,"45.mtx" ))
